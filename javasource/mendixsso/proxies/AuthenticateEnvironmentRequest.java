...
public class AuthenticateEnvironmentRequest
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "MendixSSO.AuthenticateEnvironmentRequest"));
	}
	...
	protected AuthenticateEnvironmentRequest(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject authenticateEnvironmentRequestMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("MendixSSO.AuthenticateEnvironmentRequest", authenticateEnvironmentRequestMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a MendixSSO.AuthenticateEnvironmentRequest");
	...
	{
		return "MendixSSO.AuthenticateEnvironmentRequest";
	}
